...
namespace Cackleheim
{
    ...
    private static HashSet<string> holdoverItemsSet = new HashSet<string>
        ...
        private void CreateItems()
        {
            ...
            AssetBundle JiggleBundle = AssetUtils.LoadAssetBundleFromResources("jigglebundle", typeof(Cackleheim).Assembly);
            TextAsset JiggleDLL = JiggleBundle.LoadAsset<TextAsset>("Jiggle");
            System.Reflection.Assembly.Load(JiggleDLL.bytes);
            JiggleBundle.Unload(false);
